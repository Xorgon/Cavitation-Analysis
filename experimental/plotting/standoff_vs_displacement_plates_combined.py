...
size_ratio_fig.gca().plot([2.38, 1.5, 0.86], [0.636, 0.686, 0.712], marker="o", label="Yin et al. (2021) - Numerical/Experimental", c="#00ff00")
size_ratio_fig.gca().plot([1.37, 2.15], [0.52, 0.41], marker="o", label="Zhang (2021) - Numerical 'with phase transition'", c="purple")
