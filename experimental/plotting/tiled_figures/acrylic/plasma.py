...
repeat = 7
index = 2
frame_idxs = [15, 16, 27, 38, 42, 72]

tile_tl_corner = (141, 35)
tile_br_corner = (240, 159)
img_scale = 8
fig_scale = 1

dir_path = "C:/Users/eda1g15/OneDrive - University of Southampton/Research/Slot Geometries/Data/SlotSweeps/W2H3a/"
...
reading = None
for r in readings:
    # Accept close repeats because we're just using the geometry position bit of the information
    if r.idx == index and abs(r.repeat_number - repeat) < 2:
        reading = r
...
for k, idx in enumerate(frame_idxs):
    ...
    if k == 0:
        ...
        sbar_y_pos = img_scale * (tile_tl_corner[1] + 0.13 * height)
