...
f_dir = "C:/Users/eda1g15/OneDrive - University of Southampton/Research/Porous Materials/Data/Steel plates/w20vf48squares/1 layer/Between 4 holes/movie_C001H001S0001/"
...
for k, idx in enumerate(frame_idxs):
    ...
    if k == len(frame_idxs) - 1 and include_scale:
        ...
        sbar_y_pos = img_scale * (tile_tl_corner[1] + 0.145 * height)
    ...
    draw_porous_overlay(ax, f_dir, 1.5, img_scale=img_scale, thickness=1)
...
plt.savefig("C:/Users/eda1g15/OneDrive - University of Southampton/Research/Porous Materials/"
            "paper figures/preferential_expansion.eps", dpi=300)
plt.show()
