...
repeat = 2
frame_idxs = [28, 32, 37, 40, 41, 42]

tile_tl_corner = (133, 70)
tile_br_corner = (262, 214)
img_scale = 8
fig_scale = 1

f_dir = "C:/Users/eda1g15/OneDrive - University of Southampton/Research/Porous Materials/Data/Steel plates/w20vf48squares/1 layer/Between 2 holes/movie_C001H001S0002/"
...
for k, idx in enumerate(frame_idxs):
    ...
    if k == len(frame_idxs) - 1 and include_scale:
        ...
        sbar_y_pos = img_scale * (tile_tl_corner[1] + 0.15 * height)
    ...
    draw_porous_overlay(ax, f_dir, 1.62, img_scale=img_scale, thickness=1)
...
plt.savefig("C:/Users/eda1g15/OneDrive - University of Southampton/Research/Porous Materials/"
            "paper figures/collapse_ears.eps", dpi=300)
plt.show()
