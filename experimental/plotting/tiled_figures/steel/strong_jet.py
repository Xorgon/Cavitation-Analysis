...
repeat = 0
frame_idxs = [28, 43, 47, 51, 52, 61]

tile_tl_corner = (130, 56)
tile_br_corner = (258, 264)
img_scale = 8
fig_scale = 1

f_dir = "C:/Users/eda1g15/OneDrive - University of Southampton/Research/Porous Materials/Data/Steel plates/w20vf48squares/1 layer/On a hole/movie_C001H001S0003/"
...
for k, idx in enumerate(frame_idxs):
    ...
    draw_porous_overlay(ax, f_dir, 0.05, img_scale=img_scale)
...
plt.savefig("C:/Users/eda1g15/OneDrive - University of Southampton/Research/Porous Materials/"
            "paper figures/strong_jet.eps", dpi=300)
plt.show()
