...
if not os.path.exists("corner_anisotropy_data"):
    os.makedirs("corner_anisotropy_data")
lists_to_csv(f'corner_anisotropy_data/', f'R{1000 * R_init:.1f}_L{1000 * L:.0f}_n{n}_cn{corner_n}',
