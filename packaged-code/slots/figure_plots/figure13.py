...
for i in range(len(tags)):
    num_ys, num_theta_stars, num_x_stars = csv_to_lists("figure13_data/", f"{tags[i]}_numerical", has_headers=True)
    exp_ys, exp_theta_stars, theta_errs, exp_x_stars, x_star_errs = csv_to_lists("figure13_data/",
