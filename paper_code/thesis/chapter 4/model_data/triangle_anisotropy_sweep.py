...
if not os.path.exists("triangle_anisotropy_data"):
    os.makedirs("triangle_anisotropy_data")
lists_to_csv(f'triangle_anisotropy_data/', f'R{1000 * R_init:.1f}_L{1000 * L:.0f}_n{n}_i{img_ranges}',
