...
if not os.path.exists("square_anisotropy_data"):
    os.makedirs("square_anisotropy_data")
lists_to_csv(f'square_anisotropy_data/', f'R{1000 * R_init:.1f}_L{1000 * L:.0f}_n{n}_i{img_ranges}',
