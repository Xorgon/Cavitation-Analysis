...
from experimental.util.file_utils import get_mraw_from_dir
...
mraw = get_mraw_from_dir("C:/Users/eda1g15/OneDrive - University of Southampton/Research/Porous Materials"
                         "/Data/Misc/OAP mirror testing/with plasma_C001H001S0001/")

sub_frame = np.int32(mraw[814]) - np.int32(mraw[813])
